    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="-2 -2 504 504" id="menu">
          ...
          <g id="trigger" className="trigger menu-trigger" role="button">
            ...
            <text xmlns="http://www.w3.org/2000/svg" id="blueness-label" textAnchor="middle" alignmentBaseline="central" x="250" y="235" fill="#fff">?</text>
            <text xmlns="http://www.w3.org/2000/svg" id="blueness-label-suffix" textAnchor="middle" alignmentBaseline="central" x="250" y="285" fill="#fff">AVERAGE BLUENESS</text>
